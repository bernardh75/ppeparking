...
<body>
            <div class="content">
                ...
                <div class="links">
                    ...
                    <a href="http://127.0.0.1:8000/portailinscription">Inscription</a>
...
$bdd = new PDO('mysql:host=localhost;dbname=bdd_parking', 'root', '132259');
      ...
      if($pseudolength <= 255) {
         if($mail == $mail2) {
            if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
               ...
               $mailexist = $reqmail->rowCount(); //adressemaildéjàutiliséounon
               if($mailexist == 0) {
                  if($mdp == $mdp2) {
